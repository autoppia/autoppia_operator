...
rm -rf /workspace/autoppia_operator_run/models/contact-ppo-qwen3-smoke
...
nohup python training/rl/contact_ppo_trainer.py \
  ...
  --output-dir /workspace/autoppia_operator_run/models/contact-ppo-qwen3-smoke \
  > /workspace/autoppia_operator_run/contact_ppo_qwen3_smoke.log 2>&1 < /dev/null &

echo $! > /workspace/autoppia_operator_run/contact_ppo_qwen3_smoke.pid
printf 'PID='
cat /workspace/autoppia_operator_run/contact_ppo_qwen3_smoke.pid
