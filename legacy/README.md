...
For the current Autocinema workflow, use only these paths:
- inference operator: `src/operator/agents/operator.py`
- runtime switch: `WEB_AGENT_RUNTIME=structured`
- quick eval: `python scripts/eval/eval_structured_operator.py ...`
- campaign builder: `python scripts/training/run_autocinema_training.py ...`
- short usage notes: `docs/autocinema_training_and_inference.md`

These paths avoid the older StepEngine/FSM runtime for focused Autocinema inference experiments.
