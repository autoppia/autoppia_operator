...
def run_claude_code_harvest(
    *,
    ...
    """Compatibility backend for the Autoppia Operator discovery loop.

    New code should call `training.autoppia_operator.run_autoppia_operator`.
    This function remains here because older scripts still import it from the
    historical harvester module.
    """
