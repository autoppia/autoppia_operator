...
from training.deterministic_harvester.builders.autodrive import AUTODRIVE_PLAN_BUILDERS, build_autodrive_plan
from training.deterministic_harvester.builders.autohealth import AUTOHEALTH_PLAN_BUILDERS, build_autohealth_plan
...
DETERMINISTIC_PLAN_BUILDERS: dict[tuple[str, str], DeterministicPlanBuilder] = {
    ...
    **{("autodrive", use_case): build_autodrive_plan for use_case in AUTODRIVE_PLAN_BUILDERS},
    **{("autohealth", use_case): build_autohealth_plan for use_case in AUTOHEALTH_PLAN_BUILDERS},
