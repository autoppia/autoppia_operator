"""Deterministic plans for `autolist` — same layout as :mod:`autocinema` (per-use-case action builders + enriched selectors)."""
...
_PROJECT = "autolist"
_SOURCE = "iwa_p12_autolist"
_PROMPT = "IWA p12 autolist trajectory for"

AUTOLIST_PLAN_BUILDERS = iwa_enriched_action_builders(_PROJECT)
