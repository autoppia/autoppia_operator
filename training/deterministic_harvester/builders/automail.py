"""Deterministic plans for `automail` — same layout as :mod:`autocinema` (per-use-case action builders + enriched selectors)."""
...
_PROJECT = "automail"
_SOURCE = "iwa_p06_automail"
_PROMPT = "IWA p06 automail trajectory for"

AUTOMAIL_PLAN_BUILDERS = iwa_enriched_action_builders(_PROJECT)
