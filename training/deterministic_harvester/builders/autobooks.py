"""Deterministic plans for `autobooks` — same layout as :mod:`autocinema` (per-use-case action builders + enriched selectors)."""
...
_PROJECT = "autobooks"
_SOURCE = "iwa_p02_autobooks"
_PROMPT = "IWA p02 autobooks trajectory for"

AUTOBOOKS_PLAN_BUILDERS = iwa_enriched_action_builders(_PROJECT)
