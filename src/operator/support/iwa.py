...
try:
    ...
    from autoppia_iwa.src.web_agents.act_protocol import ACT_PROTOCOL_VERSION as IWA_ACT_PROTOCOL_VERSION, ActAllowedTool, ActRequest, ActResponse, ActToolCall
    from autoppia_iwa.src.web_agents.classes import IWebAgent
    from autoppia_iwa.src.web_agents.protocol import STEP_PROTOCOL_VERSION, StepAllowedTool, StepRequest, StepResponse, StepToolCall
